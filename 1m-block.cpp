...
unordered_set<string> blockedSites;
...
unordered_set<string> load_sites(const string& filename) {
	      ...
	      struct nfq_data *nfa, void *data)
{
    ...
    if (blockedSites.find(host_domain) != blockedSites.end()){
        printf("DROP : %s\n", host_domain);
...
int main(int argc, char **argv)
{
    ...
    blockedSites = load_sites(filename); // string(argv[1])
